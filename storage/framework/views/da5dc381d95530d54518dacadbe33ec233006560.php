	...
	<div class="container px-6 mx-auto">
				  ...
				  <tbody>
					...
					<tr>
					  <td class=" pb-4 md:table-cell">
						<a href="">
						  <img src="<?php echo e(asset('images/products/'.$item->attributes->image)); ?>" class="rounded" alt="Thumbnail" style="width: 4rem">						  
						</a>
					  </td>
					  <td>
						<a href="">
					  ...
					  <td class="text-right md:table-cell">
						...
						<?php if($item->spl_price == 0): ?>
						
						$<?php echo e($item->price); ?>

						<?php else: ?>
						$<?php echo e($item->spl_price); ?>
		...
		<div class="summary">
			<div class="checkout-info">
				...
				<a class="btn btn-checkout" href="<?php echo e(route('orderpage')); ?>">Check out</a>
				<a class="link-to-shop" href="<?php echo e(route('products.list')); ?>">Continue Shopping<i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
			</div>
		</div>
	</div>
</main>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/greduation-project/gerduation-project/resources/views/cart_page/cart.blade.php ENDPATH**/ ?>