                        ...
                        <div class="wrap-price"><span class="product-price">
                            ...
                            <?php if($Product->spl_price ==0): ?>
                                    $<?php echo e($Product->price); ?>
                                     ...
                                     <input type="hidden" value="<?php echo e($Product->price); ?>"
                                      name="newPrice"/>
                                      <?php else: ?>
                                    ...
                                    <b style="text-decoration:line-through; color:#ddd">
                                      $<?php echo e($Product->price); ?> </b>
                                       ...
                                       <input type="hidden" value="<?php echo e($Product->spl_price); ?>"
                                        name="newPrice"/>
...
<?php echo $__env->make("layout.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/greduation-project/gerduation-project/resources/views/details_page/details.blade.php ENDPATH**/ ?>