    ...
    <div class="container">
        ...
        <div class=" main-content-area">
            <div class="wrap-address-billing">
                ...
                <form action="<?php echo e(route('makeorder')); ?>" method="POST" name="frm-billing">
                    <?php echo csrf_field(); ?>
                    <p class="row-in-form">
...
<?php echo $__env->make("layout.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/greduation-project/gerduation-project/resources/views/orders/orderpage.blade.php ENDPATH**/ ?>