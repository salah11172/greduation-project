        ...
        <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
            <div class="product product-style-3 equal-elem ">
                <div class="product-thumnail">
                    <a href="{{route('productdetails',["productid"=>$late['id']])}}" title="{{$product['description']}}">
                        <figure><img src="{{asset('images/products/' .$product['image'])}}" alt="mobilephone"></figure>
                    </a>
                </div>
                <div class="product-info">
                    <a href="{{route('productdetails',["productid"=>$late['id']])}}" class="product-name"><span>{{$product['name']}}</span></a>
