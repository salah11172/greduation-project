				...
				<div class="summary">
					...
					<div class="checkout-info">
						<div class="update-clear">
                            <a style="margin-left: 800px" class="btn btn-clear" href="#">Clear Shopping Cart</a>
                            <a class="btn btn-update" href="#">Update Shopping Cart</a><br>


                        </div>
						<a class="btn btn-checkout" href="checkout.html">Check out</a>
						<a style="margin-left:1000px"  class="link-to-shop" href="shop.html">Continue Shopping<i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
					</div>
